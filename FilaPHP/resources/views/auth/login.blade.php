...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="py-1" role="none">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mb-4">
                <label for="email" class="block text-gray-700 font-medium mb-2">@lang('Email')</label>
            ...
            <div class="mb-4">
                <label for="password" class="block text-gray-700 font-medium mb-2">@lang('Password')</label>
            ...
            <div class="mb-6">
                <label class="inline-flex items-center">
                    ...
                    <span class="ml-2 text-gray-700">@lang('Remember me')</span>
                </label>
            </div>
        ...
        <p class="mt-4 text-center text-gray-600">
            ...
            <a href="{{ route('register') }}" class="text-blue-600 hover:text-blue-700">@lang('Register')</a>
        </p>
    </div>
</div>
@endsection
